...
void DeviceContext::bindRenderTarget(SwapChain* swap_chain)
{
    m_device_context->OMSetRenderTargets(1, &swap_chain->m_rtv, swap_chain->m_dsv);
}

void DeviceContext::setUpDepthTesting(ID3D11DepthStencilState* dSS)
{
    m_device_context->OMSetDepthStencilState(dSS, 1);
}
