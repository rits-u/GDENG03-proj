...
void DeviceContext::setVertexBuffer(VertexBuffer* vertex_buffer)
{
    ...
    //m_device_context->IAGetIndexBuffer()
   // return true;
}
...
void DeviceContext::setTwoViewPortSize(UINT width, UINT height) {
    ...
    m_device_context->RSSetViewports(2, viewports);
}

void DeviceContext::setMultipleViewPortSizes(UINT width, UINT height)
{
    const int num = 4;
...
void DeviceContext::setConstantBuffer(GeometryShader* geometry_shader, ConstantBuffer* buffer)
{
